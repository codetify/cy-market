...
<i class="fa fa-gamepad"></i> Oyunlar
<a class="btn btn-sm btn-outline-primary" href="<?php echo base_url("admin/oyunlar/ekle"); ?>" style="float:right;text-decoration: none;"><i class="fa fa-plus-circle"></i> Yeni Ekle</a>
</div>
<div class="card-body">
...
<tr>
<td><?php echo $row->oyun_baslik; ?></td>
<td><?php echo $row->oyun_goruntulenme; ?></td>
<td><?php if($row->oyun_durum=="1") {echo "<span style='color:green;'>Aktif</span>";} else{echo "<span style='color:red;'>Aktif Değil</span>";} ?></td>
<td><?php echo $row->createdAt; ?></td>
<td><a href="<?php echo base_url("admin/oyunlar/duzenle/$row->id"); ?>" class="btn btn-sm btn-secondary">Düzenle</a> <a href="<?php echo base_url("admin/oyunlar/sil/$row->id"); ?>" class="btn btn-sm btn-danger">Sil</a></td>
</tr>
<?php } ?>
</tbody>
</table>
