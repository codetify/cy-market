...
<li class="breadcrumb-item active">Yapımcı Düzenle</li>
</ol>
<div class="card mb-3">
<div class="card-header">
<i class="fa fa-fw fa-pencil"></i> Yapımcı Düzenle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/yapimcilar/duzenle/update/$yapimcilar->id"); ?>" method="post">
<input type="hidden" name="yazar_id" value="<?php $user = $this->session->userdata("user"); echo $user["id"]; ?>">
<div class="form-group">
<label for="yapimci_adi">Kategori Adı</label>
<input type="text" class="form-control" id="yapimci_adi" name="yapimci_adi" value="<?php echo $yapimcilar->yapimci_adi; ?>">
</div>
<div class="form-group">
<label for="yapimci_url">Kısa URL (Boş bırakırsanız, otomatik olarak oluşturulur)</label>
<input type="text" class="form-control" id="yapimci_url" name="yapimci_url" value="<?php echo $yapimcilar->yapimci_url; ?>">
</div>
<div class="form-group">
<label for="yapimci_durum">Onaylı mı?</label>
<select class="form-control" id="yapimci_durum" name="yapimci_durum">
<option value="1" <?php if($yapimcilar->yapimci_durum=="1"){echo "selected";}; ?>>Onaylı</option>
<option value="0" <?php if($yapimcilar->yapimci_durum=="0"){echo "selected";}; ?>>Onaysız</option>
</select>
</div>
<div class="form-group">
