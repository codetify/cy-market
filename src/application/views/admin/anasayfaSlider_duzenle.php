...
<i class="fa fa-sticky-note"></i> Slider Düzenle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/slider/duzenle/update/$slider->id"); ?>" method="post" enctype="multipart/form-data">
...
<input type="text" class="form-control" id="slider_baslik" name="slider_baslik" value="<?php echo $slider->slider_baslik; ?>">
</div>
<div class="form-group">
<label for="slider_url">Slider URL (Harici bir sayfaya gitmesini istiyorsanız link ekleyin)</label>
<input type="text" class="form-control" id="slider_url" name="slider_url" value="<?php echo $slider->slider_url; ?>">
</div>
<div class="form-group">
...
<option value="1" <?php if($slider->slider_durum=="1"){echo "selected";}; ?>>Onaylı</option>
<option value="0" <?php if($slider->slider_durum=="0"){echo "selected";}; ?>>Onaysız</option>
</select>
</div>
