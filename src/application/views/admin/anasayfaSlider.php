...
<i class="fa fa-sticky-note"></i> Anasayfa Slider
<a class="btn btn-sm btn-outline-primary" href="<?php echo base_url("admin/slider/ekle"); ?>" style="float:right;text-decoration: none;"><i class="fa fa-plus-circle"></i> Yeni Ekle</a>
</div>
<div class="card-body">
...
<td><img src="<?php echo base_url("uploads/$row->slider_resim"); ?>" width="120"></td>
<td><?php if($row->slider_durum=="1") {echo "<span style='color:green;'>Aktif</span>";} else{echo "<span style='color:red;'>Aktif Değil</span>";} ?></td>
<td><?php echo $row->createdAt; ?></td>
<td><a href="<?php echo base_url("admin/slider/duzenle/$row->id"); ?>" class="btn btn-sm btn-secondary">Düzenle</a> <a href="<?php echo base_url("admin/slider/sil/$row->id"); ?>" class="btn btn-sm btn-danger">Sil</a></td>
</tr>
<?php } ?>
</tbody>
</table>
