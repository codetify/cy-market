...
<i class="fa fa-mobile"></i> Uygulamalar
<a class="btn btn-sm btn-outline-primary" href="<?php echo base_url("admin/uygulamalar/ekle"); ?>" style="float:right;text-decoration: none;"><i class="fa fa-plus-circle"></i> Yeni Ekle</a>
</div>
<div class="card-body">
...
<tr>
<td><?php echo $row->uygulama_baslik; ?></td>
<td><?php echo $row->uygulama_goruntulenme; ?></td>
<td><?php if($row->uygulama_durum=="1") {echo "<span style='color:green;'>Aktif</span>";} else{echo "<span style='color:red;'>Aktif Değil</span>";} ?></td>
<td><?php echo $row->createdAt; ?></td>
<td><a href="<?php echo base_url("admin/uygulamalar/duzenle/$row->id"); ?>" class="btn btn-sm btn-secondary">Düzenle</a> <a href="<?php echo base_url("admin/uygulamalar/sil/$row->id"); ?>" class="btn btn-sm btn-danger">Sil</a></td>
</tr>
<?php } ?>
</tbody>
</table>
