...
<body>
<div class="container">
<h2 class="text-center">"<?php echo $oyunlar->oyun_baslik; ?>" ekran görüntüleri</h2>
<form action="<?php echo base_url("admin/oyunlar/ekran-goruntu/upload/$oyunlar->id"); ?>" class="dropzone" id="dropForm"></form>
<hr>
...
<td><a target="_blank" style="text-decoration:none;" href="<?php echo base_url("oyun/$oyunlar->oyun_url"); ?>"><?php echo $oyunlar->oyun_baslik; ?> <i class="fa fa-external-link"></i></a></td>
<td><a href="<?php echo base_url("admin/oyunlar/ekran-goruntuleri/sil/$oyunlar->id"); ?>" class="btn btn-sm btn-danger">Sil</a></td>
</tr>
<?php } } else { ?>
<tr>
