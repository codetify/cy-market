...
<li class="breadcrumb-item active">Yapımcı Ekle</li>
</ol>
<div class="card mb-3">
<div class="card-header">
<i class="fa fa-fw fa-pencil"></i> Yapımcı Ekle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/yapimcilar/ekle/insert"); ?>" method="post">
<input type="hidden" name="yazar_id" value="<?php $user = $this->session->userdata("user"); echo $user["id"]; ?>">
<div class="form-group">
<label for="yapimci_adi">Yapımcı Adı</label>
<input type="text" class="form-control" id="yapimci_adi" name="yapimci_adi">
</div>
<div class="form-group">
<label for="yapimci_url">Kısa URL (Boş bırakırsanız, otomatik olarak oluşturulur)</label>
<input type="text" class="form-control" id="yapimci_url" name="yapimci_url">
</div>
<div class="form-group">
