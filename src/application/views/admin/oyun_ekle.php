...
<i class="fa fa-gamepad"></i> Oyun Ekle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/oyunlar/ekle/insert"); ?>" method="post" enctype="multipart/form-data">
...
<input type="text" class="form-control" id="oyun_baslik" name="oyun_baslik">
</div>
<div class="form-group">
<label for="oyun_url">Kısa URL (Boş bırakırsanız, otomatik olarak oluşturulur)</label>
<input type="text" class="form-control" id="oyun_url" name="oyun_url">
</div>
<div class="form-group">
<label for="oyun_boyut">Oyun Boyutu</label>
<input type="text" class="form-control" id="oyun_boyut" name="oyun_boyut">
</div>
<div class="form-group">
<label for="oyun_surum">Sürüm Numarası</label>
<input type="text" class="form-control" id="oyun_surum" name="oyun_surum">
</div>
<div class="form-group">
<label for="oyun_and_ios">Android ve iOS için gereken sürüm</label>
<input type="text" class="form-control" id="oyun_and_ios" name="oyun_and_ios">
</div>
<div class="form-group">
<label for="oyun_google_link">Google Play Store Link (Zorunlu Değil)</label>
<input type="text" class="form-control" id="oyun_google_link" name="oyun_google_link">
</div>
<div class="form-group">
<label for="oyun_apple_link">Apple Store Link (Zorunlu Değil)</label>
<input type="text" class="form-control" id="oyun_apple_link" name="oyun_apple_link">
</div>
<div class="form-group">
<label for="oyun_apk_link">APK Link (Zorunlu Değil)</label>
<input type="text" class="form-control" id="oyun_apk_link" name="oyun_apk_link">
</div>
<div class="form-group">
<label for="oyun_puan">Oyun Google Play Puanı</label>
<input type="text" class="form-control" id="oyun_puan" name="oyun_puan">
</div>
<div class="form-group">
...
<div class="form-group">
<label for="oyun_ekran_goruntusu">Oyun Ekran Görüntüleri</label>
(Ekran görüntülerini oyun düzenle sayfasından daha sonra ekleyebilirsiniz :))
</div>
<div class="form-group">
<label for="oyun_aciklama">Oyun Açıklaması</label>
<textarea rows="5" class="form-control" id="oyun_aciklama" name="oyun_aciklama"></textarea>
</div>
<div class="form-group">
