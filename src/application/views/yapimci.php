...
<title><?php if ($oyun_listesi && $uygulama_listesi) { echo $uyg_oyun_yapimci_title; } elseif($uygulama_listesi) {echo $uygulamalar_yapimci_title;} elseif($oyun_listesi) { echo $oyunlar_yapimci_title; } ?> | <?php echo strip_tags($ayarlar->site_title); ?></title>
...
<meta name="twitter:title" content="<?php if ($oyun_listesi && $uygulama_listesi) { echo $uyg_oyun_yapimci_title; } elseif($uygulama_listesi) {echo $uygulamalar_yapimci_title;} elseif($oyun_listesi) { echo $oyunlar_yapimci_title; } ?>">
...
<meta property="og:title" content="<?php if ($oyun_listesi && $uygulama_listesi) { echo $uyg_oyun_yapimci_title; } elseif($uygulama_listesi) {echo $uygulamalar_yapimci_title;} elseif($oyun_listesi) { echo $oyunlar_yapimci_title; } ?>">
...
<h3><span class="badge badge-secondary"><?php echo $uygulamalar_yapimci_title; ?></span></h3>
<div class="row">
...
<h3><span class="badge badge-secondary"><?php echo $oyunlar_yapimci_title; ?></span></h3>
<div class="row">
