...
<title><?php if ($oyun_listesi && $uygulama_listesi) { echo $uyg_oyun_kategori_title; } elseif($uygulama_listesi) {echo $uygulamalar_kategori_title;} elseif($oyun_listesi) { echo $oyunlar_kategori_title; } ?> | <?php echo strip_tags($ayarlar->site_title); ?></title>
...
<meta name="twitter:title" content="<?php if ($oyun_listesi && $uygulama_listesi) { echo $uyg_oyun_kategori_title; } elseif($uygulama_listesi) {echo $uygulamalar_kategori_title;} elseif($oyun_listesi) { echo $oyunlar_kategori_title; } ?>">
...
<meta property="og:title" content="<?php if ($oyun_listesi && $uygulama_listesi) { echo $uyg_oyun_kategori_title; } elseif($uygulama_listesi) {echo $uygulamalar_kategori_title;} elseif($oyun_listesi) { echo $oyunlar_kategori_title; } ?>">
...
<h3><span class="badge badge-secondary"><?php echo $uygulamalar_kategori_title; ?></span></h3>
<div class="row">
...
<h3><span class="badge badge-secondary"><?php echo $oyunlar_kategori_title; ?></span></h3>
<div class="row">
...
<span class="alert alert-danger">Kategoriye eklenmiş oyun veya uygulama bulunamadı..!<br>Eğer bu kategoriye ait oyun veya uygulama eklenmesini istiyorsanız <a target="_blank" href="<?php echo base_url("iletisim"); ?>">İletişim</a> sayfasından bizimle iletişime geçin :)</span>
<?php } ?>
</div><!-- row -->
<nav>
